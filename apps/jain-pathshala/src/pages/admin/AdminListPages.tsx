...
/* ——— Shivirs ——— */
/**
 * Moved to its own file: the list grew edit, publish/unpublish, cancel, MSV
 * and contact fields, search, a published filter and paging, which is far too
 * much to keep in the shared grouped-pages file.
 */
export { default as ShivirsPage } from '@/pages/admin/ShivirsPage';
