...
export const ADMIN_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/niyams/new', label: 'New niyam', icon: Flame, min: 'shikshak' },
      { href: '/admin/shivirs', label: 'Shivirs', icon: CalendarDays, min: 'city_admin' },
      { href: '/admin/competitions/new', label: 'New competition', icon: Award, min: 'city_admin' },
