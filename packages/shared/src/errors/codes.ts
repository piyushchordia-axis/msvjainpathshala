...
export const ERROR_CODES = {
  ...
  ERR_EXAM_OTP_NOT_SET: 'ERR_EXAM_OTP_NOT_SET',
  /** OTP only valid in the first 30 minutes of the exam window (SPEC §8.9). */
  ERR_EXAM_OTP_WINDOW_EXPIRED: 'ERR_EXAM_OTP_WINDOW_EXPIRED',
  ERR_EXAM_WINDOW_CLOSED: 'ERR_EXAM_WINDOW_CLOSED',
  ERR_EXAM_NOT_FOUND: 'ERR_EXAM_NOT_FOUND',
  ERR_EXAM_ATTEMPT_NOT_FOUND: 'ERR_EXAM_ATTEMPT_NOT_FOUND',
  ERR_EXAM_ATTEMPT_NOT_IN_PROGRESS: 'ERR_EXAM_ATTEMPT_NOT_IN_PROGRESS',
  ERR_EXAM_ATTEMPT_IN_PROGRESS: 'ERR_EXAM_ATTEMPT_IN_PROGRESS',
  ERR_EXAM_MAX_ATTEMPTS_REACHED: 'ERR_EXAM_MAX_ATTEMPTS_REACHED',
  ERR_EXAM_RESULTS_NOT_RELEASED: 'ERR_EXAM_RESULTS_NOT_RELEASED',
  ERR_EXAM_RESULTS_ALREADY_RELEASED: 'ERR_EXAM_RESULTS_ALREADY_RELEASED',
  ERR_EXAM_QUESTION_NOT_FOUND: 'ERR_EXAM_QUESTION_NOT_FOUND',
  ERR_EXAM_ANSWER_NOT_FOUND: 'ERR_EXAM_ANSWER_NOT_FOUND',

  // ----------------------------------------------------------------------
  // Domain — Curriculum (SPEC §5.13, §6.16) + CLAUDE.md Q2
  // ----------------------------------------------------------------------
  ERR_CURRICULUM_NOT_FOUND: 'ERR_CURRICULUM_NOT_FOUND',
  ERR_CURRICULUM_SECTION_NOT_FOUND: 'ERR_CURRICULUM_SECTION_NOT_FOUND',
  ERR_CURRICULUM_ITEM_NOT_FOUND: 'ERR_CURRICULUM_ITEM_NOT_FOUND',
  /** One active Standard + one active MSV per centre/batch. */
  ERR_CURRICULUM_ASSIGNMENT_CONFLICT: 'ERR_CURRICULUM_ASSIGNMENT_CONFLICT',
